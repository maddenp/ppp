...
module Fortran
                ...
                if r7
                  ...
                  if r11
                    ...
                    if r12
                      ...
                      if r14
                        i15 = index
                        r16 = lambda { |e| sp_env_pullup(e[0]) }.call(s13)
                        if r16
                          @index = i15
                      ...
                      if s13.last
                        r13 = instantiate_node(SMS_Executable_SMS_Parallel,input, i13...index, s13)
                        r13.extend(SmsExecutable1)
                      else
                        @index = i13
                        r13 = nil
                      end
                      if r13
                        ...
                        if r17
                          ...
                          if r19
                            i20 = index
                            r21 = lambda { |e| sp_env_pullup(e[0]) }.call(s18)
                            if r21
                              @index = i20
                          ...
                          if s18.last
                            r18 = instantiate_node(SMS_Executable_SMS_Serial,input, i18...index, s18)
                            r18.extend(SmsExecutable2)
                          else
                            @index = i18
                            r18 = nil
                          end
                            ...
                            if r22
                              ...
                              if r23
                                ...
                                if r24
                                  ...
                                  i25, s25 = index, []
                                  r26 = _nt_sms_to_local
                                  s25 << r26
                                  if r26
                                    i27 = index
                                    r28 = lambda { |e| sp_env_pullup(e[0]) }.call(s25)
                                    if r28
                                      @index = i27
                                  ...
                                  if s25.last
                                    r25 = instantiate_node(SMS_Executable_SMS_To_Local,input, i25...index, s25)
                                    r25.extend(SmsExecutable3)
                                  else
                                    @index = i25
                                    r25 = nil
                                  end
  ...
  def _nt_sms_serial_intent
    ...
    if node_cache[:sms_serial_intent].has_key?(index)
      ...
      if cached
        node_cache[:sms_serial_intent][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
  ...
  def _nt_sms_serial_intent_list
    ...
    if node_cache[:sms_serial_intent_list].has_key?(index)
      ...
      if cached
        node_cache[:sms_serial_intent_list][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
  ...
  def _nt_sms_serial_intent_lists
    ...
    if node_cache[:sms_serial_intent_lists].has_key?(index)
      ...
      if cached
        node_cache[:sms_serial_intent_lists][index] = cached = SyntaxNode.new(input, index...(index + 1)) if cached == true
        @index = cached.interval.end
      end
      return cached
    end
  ...
  def _nt_sms_t_get_communicator
    ...
    if has_terminal?("get_communicator", false, index)
